...
export default function Step3() {
  ...
  return (
    <>
      <Head>
        <title>DigiSwim Aufgabe 3</title>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        <Task>
          ...
          Trage in die Tabelle ein, ob der Würfel aus Fichtenholz schwimmt oder
          sinkt.
        </Task>
            ...
            <Droppable id="droppable">
              {parent === 'droppable' ? (
                <div className={`${styles.glass} ${classes.glassFull}`}>
                  <Image src={Fichte} alt="Ein Würfel aus Fichtenholz" />
                </div>
              ) : (
